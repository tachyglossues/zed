use gpui::{hsla, Styled, ViewContext};

use crate::prelude::*;
use crate::ElevationIndex;

fn elevated<E: Styled, T>(this: E, cx: &ViewContext<T>, index: ElevationIndex) -> E {
...
fn elevated_borderless<E: Styled, T>(this: E, cx: &ViewContext<T>, index: ElevationIndex) -> E {
    this.bg(cx.theme().colors().elevated_surface_background)
        .rounded_lg()
        .shadow(index.shadow())
}
...
pub trait StyledExt: Styled + Sized {
    ...
    fn elevation_1<T>(self, cx: &ViewContext<T>) -> Self {
    ...
    fn elevation_1_borderless<T>(self, cx: &ViewContext<T>) -> Self {
    ...
    fn elevation_2<T>(self, cx: &ViewContext<T>) -> Self {
    ...
    fn elevation_2_borderless<T>(self, cx: &ViewContext<T>) -> Self {
    ...
    fn elevation_3<T>(self, cx: &ViewContext<T>) -> Self {
